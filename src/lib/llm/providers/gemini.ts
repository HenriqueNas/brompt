...
export class GeminiProvider implements LLMProvider {
  async generate(apiKey: string, promptPayload: string): Promise<string> {
    ...
    throw new Error("Failed to generate prompt. All available Gemini models (Flash, Pro) failed or were not found. Please check your API key and region availability.");
  }
}
