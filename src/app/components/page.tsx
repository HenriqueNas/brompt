...
export default function ComponentsPage() {
  ...
  return (
    <div className='min-h-screen bg-[rgb(11,10,20)] p-8 font-sans text-slate-200'>
      <main className='mx-auto max-w-355 '>
        {/* Header */}
        <header className='mb-12 flex items-center justify-between border-b border-[rgb(59,50,103)] pb-6'>
          <div className='flex items-center gap-4'>
            ...
            <h1 className='text-xl font-bold text-white'>Brompt Components</h1>
          </div>
          <div className='flex items-center gap-4'>
        ...
        <div className='mb-12'>
          ...
          <p className='max-w-2xl text-lg text-slate-400'>
            ...
            high-density information, code readability, and long-session
            comfort.
          </p>
        </div>
                ...
                >
                  <div className='text-zinc-800 dark:text-zinc-200'>
                    ...
                    <p className='mt-2 text-sm text-zinc-500'>
                      It supports a title, content area, and a footer for
                      actions.
                    </p>
                  </div>
                </Modal>
