...
export const HistoryProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const [activeSession, setActiveSession] = useState<ArchitectSession | null>(null);
  ...
  return (
    <HistoryContext.Provider value={{ history, activeSession, setActiveSession, saveSession, loadSession, deleteSession, clearHistory }}>
      {children}
